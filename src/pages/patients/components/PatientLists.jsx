...
const PatientLists = ({ patient, active = false, ...rest }) => {
  ...
  return (
    <div
      ...
      className={`outline-none w-[550px] text-blue-500 rounded-xl p-1 flex items-center gap-3 hover:bg-white cursor-pointer duration-300   hover:border-blue-500 hover:shadow-lg ${
    ...
    >
      <Img
        ...
        className=" w-6 rounded-md object-contain bg-slate-200"
      />
      
      {/* FlatIcon only active when PatientMenu is active */}
     
      <div className="flex flex-row gap-4 items-center">
        <span className={`text-sm text-slate-600 font-semibold ${active ? "text-teal-600" : ""}`}>
