...
const AddPrescription = forwardRef(({
    ...
    const show = (data, appointmentData, type = null) => {
        setValue("case_date", dateMMDDYYYY());
        setModalOpen(true);
    ...
    const handleCheckboxChange = (caseCodes) => {
        ...
        const selectedItem = caseCodes.find(CASE_CODE === caseCodes);
        if (selectedItem) {
        ...
        <div className="flex flex-col w-full gap-4 pb-1">
            ...
            <div className="p-2 rounded-xl flex flex-col border justify-between shadow-lg h-[560px] ">
                ...
                <div className="flex gap-2 ">
                                                <ActionBtn
													className="px-2 !rounded-md h-8 border border-gray-400"
													type="foreground"
            ...
            <ActionBtn
                className="px-2 !rounded-md h-8 border border-green-600"
                type="teal"
                loading={loading}
                onClick={() => {
                    prescribeItems();
           ...
           ""
                ...
                <div className=" flex flex-col  h-[570px]">
                    ...
                    <TextInputField
					  ...
					  type="date"
					  error={errors?.case_date?.message}
					  {...register("case_date", {
						required: {
						  value: true,
                    ...
                    <div className="overflow-auto  bg-white py-1 h-[600px]">
						...
						{selectedDiagnosis ? (
							...
							/>
                            {selectedDiagnosis && (
                                <div className="text-xs text-gray-700 border p-1 flex gap-2 justify-between">
                                    
                                    <span><b>Case Code:</b> {selectedDiagnosis.CASE_CODE}</span> 
                                    <span><b>Case Rate:</b> {selectedDiagnosis.CASE_DESCRIPTION}</span> 
