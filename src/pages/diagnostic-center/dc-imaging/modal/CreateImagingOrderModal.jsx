...
const CreateImagingOrderModal = (props, ref) => {
	...
	const getLaboratoryTests = (type) => {
		...
		Axios.get(`/v1/laboratory/imaging/list?type=${type}`)
		  .then((res) => {
	...
	const submit = (data) => {
	  ...
	  formData.append("img_rate", selectedTest?.img_rate); // Use selectedTest for img_rate
  ...
  export default forwardRef(CreateImagingOrderModal);